...
//    }
    ...
    private void initComponents() {
        ...
        jSplitPane1.setPreferredSize(new java.awt.Dimension(2560, 1600));
        ...
        container.setBackground(new java.awt.Color(246, 193, 28));
        container.setLayout(new java.awt.CardLayout());

        jLabel3.setIcon(new javax.swing.ImageIcon("/Users/jayashree/Desktop/adac_socialmedia_march2018-v3.gif")); // NOI18N
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        // Do Something with the user account we found
         if(ua == null){
               JOptionPane.showMessageDialog(null, "Invalid User");
               return;
         }else{
            CardLayout layout=(CardLayout) container.getLayout();
            container.add("workArea",ua.getRole().createWorkArea(container, ua, inOrganization, inEnterprise, system, inNetwork));
            layout.next(container);
         }
         logoutJButton.setEnabled(true);
         loginJButton.setEnabled(false);
